        ...
        <section id="results" ref={sectionRef} className="relative w-full py-24 md:py-40 bg-transparent overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col md:flex-row gap-16 md:gap-24 items-center">
                ...
                <div className="w-full md:w-1/3 flex flex-col items-start md:sticky md:top-40 md:self-start">
                    ...
                    >
                        <span className="px-4 py-1.5 text-xs font-bold tracking-widest uppercase text-brand-mint/90 bg-brand-mint/10 border border-brand-mint/20 rounded-full inline-block mb-6 shadow-[0_0_15px_rgba(34,211,238,0.2)]">
                            The Value I Bring
                        </span>
                ...
                <div className="w-full md:w-2/3 flex flex-col gap-8 md:gap-10">
                    {impactList.map((item, idx) => (
                        <motion.div
                            ...
                            className="group flex flex-col sm:flex-row gap-6 p-8 md:p-10 rounded-[2rem] bg-[#0a0a0a] border border-white/[0.04] hover:bg-[#0c0c0c] hover:border-white/10 transition-all duration-500 hover:shadow-[0_0_30px_rgba(255,255,255,0.02)]"
                        >
